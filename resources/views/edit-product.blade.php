      ...
      <div class="flex w-full gap-4 flex-1">
        <div class="flex flex-col w-full">
          ...
          <div class="mb-6">
            ...
            <input type="number" value="{{ old('discount', $product->discount) }}" style="-moz-appearance: textfield;" name="discount" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
          </div>
          <div class="mb-6">
