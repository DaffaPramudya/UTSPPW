      ...
      <div class="p-8 sm:py-14 sm:px-20 border shadow-lg rounded-lg md:p-8">
        <form action="/register" method="post" class="flex flex-col mb-6">
          ...
          <div class="border-solid border py-3 px-3 mb-2 rounded-lg flex items-center overflow-hidden">
            ...
            <input class="border rounded-lg p-3 outline-none text-sm w-full" type="text" name="username" placeholder="Username" value="{{ old('username') }}">
          </div>

          <!-- email -->
          <div class="border-solid border py-3 px-3 mb-2 rounded-lg flex items-center overflow-hidden">
            <i class="fa-solid fa-envelope w-4 h-4 mr-3"></i>
            <input class="border rounded-lg p-3 outline-none text-sm w-full" type="email" name="email" placeholder="Email" value="{{ old('email') }}">
          </div>
          ...
          <div class="border-solid border py-3 px-3 mb-5 rounded-lg flex items-center overflow-hidden">
            ...
            <input class="border rounded-lg p-3 outline-none text-sm w-full" type="password" name="password" placeholder="Password">
          </div>
