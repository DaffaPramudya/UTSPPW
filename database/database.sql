...
--
-- Host: localhost
-- Generation Time: Nov 16, 2024 at 05:06 PM
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `produk` (`idProduk`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
